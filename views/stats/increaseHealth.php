...
<h2>Increase <?= $parameters['character']; ?>'s health :</h2>

<form method="post" action="/jdr/increase-character-health">
	...
	<div class="form-group">
		<button type="submit" class="btn btn-primary">Increase Health</button>
	</div>
