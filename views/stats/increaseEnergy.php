...
<h2>Increase <?= $parameters['character']; ?>'s energy :</h2>

<form method="post" action="/jdr/increase-character-energy">
	...
	<div class="form-group">
		<button type="submit" class="btn btn-primary">Increase Energy</button>
	</div>
